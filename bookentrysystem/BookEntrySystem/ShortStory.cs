    ...
    public partial class ShortStory : Form
    {
         ...
         try
            {
                ...
                //sql query
                String query_insert = "insert into Tableshortstory values('" + name + "','" + auther + "','" + code + "','" + publisher + "','" + price + "')";
                //sql command
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String query_search = "select *from Tableshortstory where code='" + u_code + "'";
        ...
        private void btnupdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String query_update = "update Tableshortstory set name='" + name + "',auther='" + auther + "',code='" + code + "',publisher='" + publisher + "',price='" + price + "' where code='" + code + "' ";
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
             try
            {
                ...
                String query_delete = "delete from Tableshortstory where code='" + code + "'";
