    ...
    public partial class Translations : Form
    {
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //sql query
                String query_insert = "insert into Tabletranslations values('" + name + "','" + auther + "','" + code + "','" + publisher + "','" + price + "')";
                //sql command
        ...
        private void btnupdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String query_search = "select *from Tabletranslations where code='" + u_code + "'";
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String query_delete = "delete from Tabletranslationswhere code='" + code + "'";
